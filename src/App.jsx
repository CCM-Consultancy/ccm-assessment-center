...
const RUBRIC = [
  {score:1,label:"Well below expectation",color:"#dc2626",bg:"#fef2f2",desc:"Little to no evidence of the competency. Response was vague, incomplete, or absent."},
  {score:2,label:"Below expectation",color:"#ea580c",bg:"#fff7ed",desc:"Some evidence but significant gaps. Limited depth or structure in response."},
  {score:3,label:"Meeting expectation",color:"#ca8a04",bg:"#fefce8",desc:"Clear evidence of the competency. Response was structured and relevant."},
  {score:4,label:"Above expectation",color:"#16a34a",bg:"#f0fdf4",desc:"Strong evidence with depth. Response was insightful, specific and well-reasoned."},
  {score:5,label:"Exceptional",color:"#0369a1",bg:"#eff6ff",desc:"Outstanding evidence. Response significantly exceeded expectations in depth and sophistication."},
];
...
const MODULES = [
  {
    ...
    guide:[
      {
        qId:"Q1",competency:"Communication",
        modelAnswer:"The first action is to activate the ground operations emergency protocol and notify the Operations Control Centre, Terminal Manager, VP of Airport Operations, and airline partner liaisons simultaneously - not sequentially. A dedicated incident commander role should be assigned immediately so the Head of Ground Operations can coordinate rather than react. Ground staff should receive a three-minute stand-up briefing with clear task allocation: prioritise bags for the three aircraft approaching penalty thresholds first, then work through departures by schedule time. A passenger communication point should be established at each carousel with a committed update schedule every 10 to 15 minutes. The airport authority should receive a formal written update within the first 10 minutes, and a holding statement for media should be issued before the 15-minute mark. All decisions and actions should be logged in real time for the post-incident review.",
        strongIndicators:["Activates formal crisis protocol immediately rather than improvising","Contacts all critical stakeholders simultaneously not sequentially","Assigns an incident commander to separate coordination from response","Prioritises by commercial impact - penalty threshold flights first","Establishes a passenger communication cadence with specific timing","Issues a holding statement to media before being approached"],
        weakIndicators:["Contacts stakeholders one by one losing critical time","Attempts to personally manage every workstream simultaneously","Waits to fully understand the problem before communicating anything","Has no structured prioritisation framework - treats all bags equally","Makes commitments to stakeholders without confirming operational capacity"],
        bestAnswer:"A score of 5 response would: activate the emergency protocol in the first sentence, assign an incident commander, contact all five stakeholder groups within the first three minutes, prioritise by penalty threshold, commit to a 10-minute update cadence, and reference the post-incident review process. The candidate would demonstrate they understand that communication and operations must run in parallel, not sequentially.",
        rolePlayGuide:"In the role play, a strong candidate will open by acknowledging the representative's frustration before providing any information. They will state the specific actions being taken for that representative's aircraft, give a realistic timeline, and offer a named point of contact. They will not make promises they cannot keep. A weak candidate will be defensive, provide vague assurances, or prioritise their own explanation over listening to the representative's concern."
      },
      {
        qId:"Q2",competency:"Accountability",
        modelAnswer:"The immediate priority is operational: the engineer remains on shift and is needed. A brief private conversation - no more than two minutes - should acknowledge that the situation will be reviewed formally but that the focus right now is on resolution. This preserves the individual's dignity and keeps them effective during the crisis. The failure should be logged immediately as a formal incident report with a timestamp, and the engineer's manager should be notified in writing. After the crisis, a structured accountability process should be initiated within 24 hours: a formal meeting with HR present, a review of whether the non-escalation was a training gap, a process gap, or a conduct issue, and a systemic review of whether the escalation protocol itself is clear and accessible. The outcome should address both the individual and the system that allowed the warning to go unactioned.",
        strongIndicators:["Separates the immediate operational need from the accountability process","Has a brief private conversation - does not ignore or publicly address it","Logs the incident formally in real time with a timestamp","Initiates a structured post-crisis accountability process within 24 hours","Distinguishes between a training gap, a process gap, and a conduct issue","Reviews the escalation protocol itself - not just the individual's behaviour"],
        weakIndicators:["Publicly addresses or reprimands the engineer in front of colleagues","Ignores the accountability issue entirely to focus on the crisis","Launches a formal investigation immediately, removing the engineer from the response","Assumes malicious intent without evidence","Treats it purely as an individual failure without reviewing the system"],
        bestAnswer:"A score of 5 response demonstrates emotional intelligence by keeping the engineer engaged and dignified while still taking the accountability issue seriously. The candidate references a specific HR or conduct process, distinguishes between systemic and individual failure, and commits to a timeline for the post-incident review. They understand that accountability and operational effectiveness are not in conflict if managed correctly.",
        rolePlayGuide:"Not applicable for this question - the role play covers the external stakeholder communication dimension."
      },
      {
        qId:"Q3",competency:"Communication",
        modelAnswer:"Sample statement: 'We are aware of a technical issue affecting baggage processing in Terminal 2 and our teams are working urgently to resolve it. We apologise sincerely for the disruption this is causing to your journey and we are doing everything possible to minimise delays to your flight. Our team will provide an update at every information desk and on departure screens every 15 minutes. If you have any concerns, please speak to a GlobalAir team member in a red vest who is available throughout the terminal.' Communication principles: the statement opens with acknowledgement not explanation, uses plain language accessible to all passenger nationalities, makes a specific and credible commitment on update timing, and directs passengers to a visible human resource. It deliberately omits the cause of the failure, the identity of any individuals involved, and any estimate of resolution time that cannot be guaranteed.",
        strongIndicators:["Opens with acknowledgement rather than explanation or justification","Uses plain, jargon-free language appropriate for an international passenger audience","Makes a specific and credible commitment on update frequency","Directs passengers to a named and visible point of contact","Deliberately omits unconfirmed information such as cause and resolution time","Explains the reasoning behind what was included and excluded"],
        weakIndicators:["Opens with an explanation of what went wrong before acknowledging impact","Uses technical or operational language passengers will not understand","Makes vague commitments such as 'as soon as possible'","Mentions the maintenance warning or any internal process failure publicly","Provides a resolution estimate that cannot be guaranteed","Cannot explain the communication choices made"],
        bestAnswer:"A score of 5 response produces a polished, empathetic, and specific statement that a communications professional would approve without edits. The candidate then articulates a clear framework for their choices, referencing audience awareness, risk of over-promising, and the importance of directing passengers to human contact. They demonstrate understanding that what is left out of a crisis communication is as important as what is included.",
        rolePlayGuide:"The role play involves an angry airline partner representative. A strong candidate will listen first, acknowledge the commercial impact specifically, provide a named point of contact and a specific timeline for their aircraft, and not make financial commitments without authority. They will remain calm and professional under pressure and will not become defensive when challenged."
      },
    ],
    rolePlay:{
      title:"Role Play: Angry Airline Partner Representative",
      setup:`An airline partner account representative calls you directly at 07:10. Three of their aircraft are at risk of triggering the contractual penalty clause that activates after 45 minutes of ground handling delay. They are furious, threatening to escalate to GlobalAir's CEO and to raise a formal contractual penalty claim worth USD 180,000. You must manage this call while your team is still resolving the crisis on the ground.`,
      setupSimple:`A manager from a partner airline calls you at 07:10, very unhappy that three of their flights are going to be delayed because of the baggage failure. They are threatening to complain to your CEO and are talking about financial penalties. You need to handle this call while your team is still trying to fix the problem.`,
      aiRole:`You are an angry airline partner representative. Three of your aircraft are approaching the penalty clause threshold. You are furious and threatening to escalate to the CEO and raise a USD 180,000 penalty claim. Open with strong frustration. Probe firmly on: what caused this, what is being done specifically for your aircraft, what compensation will be offered, and when normal operations will resume. Do not accept vague assurances. After four to five exchanges, begin to soften if the candidate demonstrates genuine empathy, gives you specific information about your aircraft, and commits to a named contact person. Stay in character throughout. Keep responses to three to four sentences.`,
      competencies:["Communication","Accountability"],
    },
    simPrompt:`You are a senior aviation operations assessor conducting a structured competency interview on behalf of CCM Consultancy. The candidate has completed a written assessment on a baggage system crisis scenario at a major airline hub. Your role is to probe their thinking more deeply through varied, incisive questions. Never repeat a question. Rotate across these dimensions: depth of thinking, specific examples, lessons learned, stakeholder awareness, and future application. Keep each response to two to three sentences. Do not give feedback or praise. Ask only questions.`,
  },
  {
    ...
    questions:[
      ...
      {id:"Q2",text:"The CFO has presented you with two immediate options: Option A is to suspend the six routes operating below 60% load factor, generating estimated annual savings of USD 8 million but resulting in the redundancy of approximately 340 operational staff and triggering political sensitivity given the government shareholder's regional connectivity mandate. Option B is to invest USD 12 million from the strategic budget in a fleet efficiency upgrade programme projected to reduce fuel costs by 11% over 18 months. You cannot pursue both simultaneously given the cash runway constraint. Walk through your complete decision-making process, including what additional information you would seek, what framework you would apply, and what recommendation you would make and why.",textSimple:"The finance team has given you two choices. Option A: stop six low-performing routes and save USD 8 million a year, but 340 staff would lose their jobs and the government shareholder may object. Option B: spend USD 12 million on improving the aircraft engines to save fuel costs, but this takes 18 months to show results. You cannot do both at once. How do you decide? What do you need to know first, how do you think through it, and what do you recommend?",competency:"Decision Making"},
      {id:"Q3",text:"Prepare a detailed allocation of the USD 50 million strategic investment budget across the key initiatives in your recovery plan. For each allocation, state the amount, the strategic rationale, the expected outcome, and the timeline for results. Your total must equal USD 50 million and your allocations should reflect the sequencing and priorities you identified in Question 1.",textSimple:"You have USD 50 million to invest in the airline's recovery. How would you divide this money across different areas of the business? For each area, state how much you would spend, why you would spend it there, what you expect it to achieve, and when you expect to see results. Your total must add up to exactly USD 50 million.",competency:"Strategic Thinking"},
    ],
    guide:[
      {
        qId:"Q1",competency:"Strategic Thinking",
        modelAnswer:"Priority 1 is cash stabilisation in Year 1: the 14-month runway is the single most urgent constraint and all other strategic choices must be sequenced around it. This means exiting the six sub-60% load factor routes within 30 days, renegotiating fuel procurement contracts, and freezing all non-essential capital expenditure. Priority 2 is competitive repositioning in Year 2: with the cash position stabilised, the airline must define what it stands for against the low-cost entrants. A premium differentiation strategy on the high-yield routes, combined with a loyalty programme rebuild, will defend the most profitable customer segments. Priority 3 is selective growth in Year 3: once the cost base is restructured and competitive position is clarified, limited route expansion into underserved markets where MidReach has a natural advantage - such as routes where the low-cost carriers have not yet entered - becomes viable. The three-year sequencing is non-negotiable: attempting repositioning before stabilisation, or growth before repositioning, will consume capital that does not yet exist.",
        strongIndicators:["Identifies the cash runway as the primary constraint that drives all sequencing","Uses specific data from the case to support each priority","Applies a clear Year 1/2/3 phasing framework rather than treating all three years identically","Acknowledges the political dimension of route suspension and addresses it","Connects the competitive analysis to a specific strategic positioning choice","Does not attempt to solve everything in Year 1"],
        weakIndicators:["Lists generic priorities not grounded in the specific case data provided","Ignores the 14-month cash runway as the binding constraint","Proposes growth initiatives in Year 1 before stabilisation is achieved","Does not sequence priorities - presents them as a simultaneous list","Fails to distinguish between what MidReach can control and what is driven by market forces"],
        bestAnswer:"A score of 5 response will name all three priorities with specific case evidence, apply a clear sequencing logic tied to the cash runway, acknowledge the political and people dimensions, and demonstrate an understanding that recovery strategy is about sequencing and trade-offs as much as it is about the right initiatives. The candidate will connect each priority to a specific stakeholder outcome.",
        rolePlayGuide:"The Board member role play tests composure, evidence-based reasoning, and the ability to defend a position under sustained pressure. A strong candidate will not capitulate to the Board member's scepticism but will engage with it specifically, referencing data and comparable cases. They will acknowledge genuine uncertainties while maintaining confidence in their framework."
      },
      {
        qId:"Q2",competency:"Decision Making",
        modelAnswer:"The decision cannot be made responsibly without first confirming three things: the exact cash position at the time of decision, the legal and contractual obligations around the route suspension redundancies, and whether the government shareholder has any veto rights or consultation requirements under the shareholder agreement. Assuming the 14-month runway is accurate and there are no immediate legal barriers, a binary choice between Options A and B is a false framing. The more important question is what combination or sequencing of actions preserves the cash runway while minimising irreversible damage. A recommended approach would be: implement a partial route suspension of the three worst-performing routes immediately to generate approximately USD 4 million in annual savings, use this to extend the runway and create space for the fuel efficiency analysis to be completed rigorously, then make the fleet upgrade decision with better data at the 60-day mark. This avoids the full political and human cost of Option A while not committing USD 12 million to Option B before the analysis is complete. The recommendation should be presented to the CEO and CFO jointly before going to the Board.",
        strongIndicators:["Immediately identifies the binary framing as a false choice","Seeks specific additional information before recommending","Checks legal and shareholder agreement obligations before acting","Proposes a sequenced hybrid approach rather than a binary selection","Distinguishes between reversible and irreversible decisions","Involves the CEO and CFO before taking the recommendation to the Board"],
        weakIndicators:["Makes a firm recommendation without seeking additional information","Accepts the binary framing without challenging it","Ignores the political dimension of the government shareholder's regional connectivity mandate","Does not consider a phased or hybrid approach","Makes the decision unilaterally without involving senior leadership"],
        bestAnswer:"A score of 5 response challenges the binary framing in the first sentence, seeks three to four specific pieces of additional information, proposes a sequenced hybrid approach with specific numbers, and recommends a governance process for the final decision. The candidate demonstrates that sophisticated decision-making is about reframing the question as much as answering it.",
        rolePlayGuide:"The sceptical Board member will push hardest on three areas: the realism of the financial projections, the candidate's credibility as a recent hire, and the timeline for results. A strong candidate will engage each challenge with specific evidence, acknowledge genuine uncertainties honestly, and demonstrate composure without becoming defensive or deferential."
      },
      {
        qId:"Q3",competency:"Strategic Thinking",
        modelAnswer:"A well-structured allocation would be: USD 15 million for fleet efficiency upgrade (phased across 18 months, reducing fuel costs by approximately 11% and generating USD 7-8 million in annual savings from Month 19 onwards). USD 12 million for route restructuring and market analysis (covering redundancy costs for partial route suspension, market research for growth route identification, and slot relinquishment costs). USD 10 million for loyalty programme rebuild and digital commercial capability (defending high-yield corporate accounts and creating a data asset for future commercial decisions). USD 8 million for people investment including retention payments for critical skills, union negotiation support, and a change management programme. USD 5 million held as a contingency reserve for regulatory, legal, or market contingencies. Total: USD 50 million. The allocation front-loads people and process investment in Years 1 and 2 and phases the fleet upgrade to begin generating returns by the end of Year 2.",
        strongIndicators:["Allocations add exactly to USD 50 million","Each allocation has a stated rationale and expected outcome","The allocation reflects the Year 1/2/3 sequencing from Question 1","Includes a contingency reserve - demonstrates financial discipline","Addresses the people dimension explicitly rather than as an afterthought","Connects the fleet upgrade to a specific fuel cost reduction projection"],
        weakIndicators:["Allocations do not add to USD 50 million","No rationale is provided for individual line items","The allocation ignores the cash runway constraint and front-loads long-payback investments","No contingency reserve is included","The people and union dimension is absent from the allocation","The allocation contradicts the priorities stated in Question 1"],
        bestAnswer:"A score of 5 response presents a fully costed, internally consistent allocation that adds to exactly USD 50 million, connects each line to the strategic priorities from Question 1, includes a contingency reserve, and acknowledges the phasing of returns. The candidate demonstrates financial literacy and the ability to translate strategy into resource decisions.",
        rolePlayGuide:"The sceptical Board member will specifically challenge the fleet upgrade allocation as too large and the contingency reserve as an admission of uncertainty. A strong candidate will defend both with specific reasoning: the fleet upgrade has the highest NPV of any single initiative, and a contingency reserve is a standard feature of any credible financial plan."
      },
    ],
    rolePlay:{
      title:"Role Play: Sceptical Board Member",
      setup:`You are presenting your 90-day recovery strategy to the MidReach Board. A non-executive Board member with a background in private equity has significant doubts about your plan. They are pushing back hard on the realism of your financial assumptions, the credibility of your USD 50 million allocation, the 18-month payback on the fleet upgrade, and your personal credibility as someone who joined the organisation only three weeks ago. This conversation takes place before the full Board vote on whether to approve the plan.`,
      setupSimple:`You are presenting your recovery plan to the MidReach leadership team. One senior leader is sceptical and does not believe the plan will work. They are questioning your financial assumptions, your proposed spending, and your experience. The Board will vote on the plan after this conversation. You need to defend your thinking clearly and professionally.`,
      aiRole:`You are a non-executive Board member with a private equity background. You have serious doubts about the recovery plan. Challenge the candidate firmly on: the realism of the 14-month runway figure and whether it accounts for seasonal cash flow variation, the USD 12 million fleet upgrade allocation given the cash constraint, the absence of a detailed headcount reduction plan, and the candidate's credibility as a three-week hire making USD 50 million decisions. Ask sharp and specific questions. Do not accept vague or generic answers. If the candidate demonstrates specific financial reasoning and composure, gradually become more open. Keep responses to three to four sentences. Be professional but demanding throughout.`,
      competencies:["Strategic Thinking","Decision Making"],
    },
    simPrompt:`You are a senior aviation strategy assessor conducting a structured competency interview on behalf of CCM Consultancy. The candidate has completed a written assessment on a strategic airline recovery case. Probe their strategic reasoning, prioritisation logic, and decision-making under uncertainty. Never ask the same question twice. Rotate across: evidence base for decisions, identification of risks not mentioned, stakeholder considerations, how they would course-correct if the plan fails, and what success looks like at 12 months. Keep each response to two to three sentences. Do not give feedback. Ask only questions.`,
  },
  {
    ...
    caseStudy:{
      ...
      currentState:`An internal engagement survey conducted last quarter reveals that only 38% of cabin crew feel valued by the organisation, down from 61% two years ago. Sickness absence is running at 14% against a full-service airline industry average of 6%, costing the airline an estimated USD 4.2 million annually in sick pay, disruption costs, and overtime. Three of SkyServe's most experienced base managers, each with more than ten years of service, have resigned in the past month. Two cited lack of senior leadership support and unclear strategic direction. The third left to join a competitor that offered a structured career development pathway. A high-profile passenger complaint about cabin crew conduct on a flagship route was shared on social media eight days ago, has now been viewed 50,000 times, and has generated 340 comments, the majority of which are negative. The union representing cabin crew is due to open formal negotiations in six weeks, and the union representative has publicly stated that the membership's confidence in airline management is at an all-time low.`,
      challenge:`You have inherited a team in crisis on your third day in post, with no time to conduct a structured listening exercise before the most urgent issues demand your attention. The viral social media complaint must be addressed publicly in a way that does not inflame the situation further or undermine the cabin crew team. The union negotiation in six weeks must not be allowed to escalate into industrial action that would ground flights and damage the airline's recovery trajectory. The three base manager vacancies create an immediate leadership gap at the most critical level of the organisation, and the remaining base managers are reported to be considering their own positions. The underlying causes of low engagement, high absence, and poor retention must be addressed through a credible and specific plan that demonstrates to crew that this VP appointment is different from the previous three.`,
      yourRole:`You are the newly appointed VP of Cabin Services at SkyServe Airlines, responsible for the strategic leadership, performance, wellbeing, and development of 1,400 cabin crew across four bases. You report directly to the CEO and have a seat on the airline's executive committee. You have a dedicated HR business partner, a training and standards team of eight, and four base managers (one position currently vacant with two more at risk). This is your third day in the role. You have been given a clear mandate by the CEO: stabilise the team, restore engagement, and deliver a measurable improvement in cabin crew performance and morale within 12 months.`,
    },
    caseStudySimple:{
      background:`SkyServe Airlines has been operating for 18 years and has grown quickly over the past five, doubling the number of aircraft in its fleet. The airline has 1,400 cabin crew working from four different bases in different cities. Cabin crew are the most important face of the airline for passengers, and how they perform directly affects whether passengers choose to fly with SkyServe again. As the airline grew, it did not always invest in the tools and systems needed to manage and support its people well. There is no structured way to review or develop cabin crew performance, the recognition programme has not been updated in six years, and different bases treat crew differently when it comes to rosters and scheduling, which has created a strong feeling of unfairness. Three VPs of Cabin Services have left in the past four years, which means the team has had little consistent leadership and has lost trust in senior management.`,
      currentState:`A recent staff survey shows that only 38% of cabin crew feel valued by the airline, compared to 61% two years ago. Many staff are calling in sick, with absence running at more than double the industry average, costing the airline around USD 4.2 million every year. Three experienced base managers have resigned in the past month, two of them saying they did not feel supported by senior leadership. A passenger complaint about crew behaviour on a popular route was posted on social media eight days ago and has now been seen by 50,000 people with hundreds of negative comments. The cabin crew union is due to begin formal pay and conditions negotiations in six weeks and has publicly said that crew confidence in management is at its lowest point ever.`,
      challenge:`You have arrived into a very difficult situation on only your third day in the role and there is no time to wait before acting. The social media complaint needs a response that does not make things worse or upset the crew further. The union negotiation must be handled carefully so it does not lead to strike action that would cancel flights. Three base manager positions need to be filled or covered immediately, and the remaining managers may also be considering leaving. The team needs to see and hear from you quickly and to believe that your appointment will make a real difference compared to the three VPs who came before you.`,
      yourRole:`You are the newly appointed VP of Cabin Services at SkyServe Airlines. You are responsible for leading, developing, and supporting 1,400 cabin crew across four bases. You report directly to the CEO and are a member of the executive team. You have an HR business partner and a training team to support you. This is your third day in the role and the CEO has asked you to stabilise the team and show measurable improvement in engagement and performance within 12 months.`,
    },
    questions:[
      {id:"Q1",text:"You are scheduled to address all 1,400 cabin crew across four bases in a series of all-hands sessions beginning in 48 hours. This is your first direct communication with the full team as their new VP. Describe in detail: the key messages you will deliver, the specific commitments you will make, how you will structure the session to create dialogue rather than monologue, and the tone and style you will adopt to begin rebuilding trust with a team that has seen three VPs come and go in four years.",textSimple:"In 48 hours you will speak to all 1,400 of your cabin crew across four bases for the first time as their new leader. What will you say to them? What specific promises will you make? How will you make it a two-way conversation rather than just a speech? What tone will you use to help a team that has lost trust in leaders to start trusting you?",competency:"Communication"},
      {id:"Q2",text:"The union representative has contacted you directly requesting an urgent pre-negotiation meeting before the formal talks begin in six weeks. Describe your approach to this meeting: what is your opening position, what are your three non-negotiable red lines, what are the areas where you have genuine flexibility, and how do you build a productive relationship with the union representative given that their members' confidence in management is at an all-time low?",textSimple:"The union representative has asked to meet you before the formal negotiations start in six weeks. How do you prepare for and approach this meeting? What are the things you absolutely will not agree to? Where are you willing to be flexible? How do you start to build a better relationship with the union when their members have so little trust in airline management right now?",competency:"People Leadership"},
      {id:"Q3",text:"Design a detailed 90-day people leadership plan that specifically addresses the three core issues identified in the case: low engagement at 38%, absence running at 14%, and the retention crisis among base managers and experienced crew. Your plan must include specific milestones at Day 30, Day 60, and Day 90, measurable targets for each milestone, and a clear description of how you will resource and govern the plan given that you are starting with only three of your four base manager positions filled.",textSimple:"Create a detailed 90-day plan to address the three main problems in the case: low engagement among cabin crew, very high absence rates, and experienced people leaving the airline. What specific things will you do and by when? What would success look like at Day 30, Day 60, and Day 90? How will you manage the plan when one of your four base manager positions is empty?",competency:"People Leadership"},
    ],
    guide:[
      {
        qId:"Q1",competency:"Communication",
        modelAnswer:"The session should open with a direct acknowledgement of the team's experience: 'I know the last four years have been difficult and I know that three VPs in four years has made it hard to believe that this time will be different. I am not going to ask you to trust me today. I am going to earn that trust.' This framing immediately differentiates the new VP from predecessors without criticising them. The three specific commitments should be: a visible leadership presence with each base visited within the first 30 days, a formal review of rostering fairness completed within 60 days with findings shared transparently, and the launch of a crew recognition programme within 30 days that does not require a budget approval cycle. The session should be structured as 10 minutes of opening statement, 20 minutes of moderated small group questions (not open floor Q&A which can become a complaint session), and a written commitment card distributed at the end listing the three commitments with named deadlines. The tone should be direct, warm, and specific - avoiding corporate language, generic motivational statements, and any reference to targets or metrics in the first session.",
        strongIndicators:["Opens by acknowledging the team's specific experience rather than introducing themselves","Makes three specific and credible commitments with named deadlines","Structures for dialogue rather than monologue - small group Q&A not open floor","Distributes a written record of commitments so the team can hold the VP accountable","Addresses the viral social media incident directly without undermining the team","Avoids corporate language and generic motivational statements"],
        weakIndicators:["Opens with a biography or career history rather than acknowledging the team's experience","Makes generic commitments such as 'I will listen' or 'things will be different'","Structures the session as a one-way presentation with Q&A at the end","Does not address the viral complaint or the departure of the three base managers","Uses corporate or strategic language that creates distance from frontline crew","Cannot articulate a specific tone or style difference from a standard leadership communication"],
        bestAnswer:"A score of 5 response demonstrates that the candidate understands the specific psychological and cultural context of a team that has lost trust in leadership through repeated disappointment. They open with acknowledgement not aspiration, make specific and testable commitments, and design a session format that creates genuine dialogue. They can articulate exactly why they made each communication choice.",
        rolePlayGuide:"The resistant crew member role play tests emotional intelligence and the ability to lead through resistance. A strong candidate will listen without interrupting, ask questions before providing answers, acknowledge the crew member's specific experience including the missed promotion, and make at least one specific commitment that addresses that individual's development. They will not offer false reassurance or make promises they cannot keep."
      },
      {
        qId:"Q2",competency:"People Leadership",
        modelAnswer:"The pre-negotiation meeting should open with listening, not positioning. The VP should arrive with no formal proposal and spend the first 20 minutes asking the union representative what their members most need to feel heard and respected, independent of any specific pay or conditions demand. This signals a different style of engagement from previous management. The three non-negotiable red lines are: no blanket amnesty for verified conduct violations that compromise passenger safety, no pay commitments that exceed the approved budget envelope without Board authorisation, and no changes to safety-critical rostering standards without sign-off from the Director of Flight Operations. The areas of genuine flexibility include: a formal review of the rostering fairness issue with joint union involvement, a transparent absence management framework co-designed with union input, and a commitment to a structured crew development and promotion pathway within 12 months. The relationship should be framed from the outset as a partnership in improving crew experience, not an adversarial negotiation. The VP should commit to monthly update meetings with the union representative between now and the formal talks.",
        strongIndicators:["Opens the pre-negotiation meeting by listening rather than presenting a position","Clearly defines three specific non-negotiable red lines","Identifies genuine areas of flexibility and communicates them honestly","Proposes a partnership framing rather than adversarial positioning","Commits to regular contact between now and the formal negotiation","Does not make financial commitments outside their authorised budget"],
        weakIndicators:["Arrives at the pre-negotiation meeting with a formal opening position","Cannot define any red lines - agrees to everything to avoid conflict","Cannot identify any areas of genuine flexibility","Treats the meeting as an adversarial negotiation from the first exchange","Makes financial commitments that exceed their authorised authority","Has no plan for the relationship between the pre-negotiation meeting and the formal talks"],
        bestAnswer:"A score of 5 response demonstrates sophisticated stakeholder leadership: the ability to engage constructively with a party whose interests are not always aligned with the organisation's, while maintaining clear boundaries. The candidate listens first, defines red lines and flexibility with specificity, and builds a relationship framework that extends beyond the formal negotiation.",
        rolePlayGuide:"The resistant crew member role play specifically tests whether the candidate can move someone from resistance to cautious openness through the quality of their listening and the specificity of their response. A weak candidate will either capitulate to every complaint or become defensive. A strong candidate will make the crew member feel genuinely heard before making any commitment."
      },
      {
        qId:"Q3",competency:"People Leadership",
        modelAnswer:"Day 1 to 30 - Listen and stabilise: visit all four bases within 30 days, completing structured listening sessions with groups of no more than 15 crew members at each base. Appoint an interim base manager for the vacant position from the existing senior crew pool to maintain leadership continuity. Review absence data by base, route, and crew demographic to identify patterns. Launch the crew recognition programme with nominations open in Week 2. Target: completion of all four base visits and interim appointment confirmed by Day 30. Day 31 to 60 - Diagnose and commit: publish the findings from the listening sessions to all crew within 48 hours of the final session, with a clear statement of what will change and what will not, and why. Complete the rostering fairness audit with union involvement and publish interim findings. Launch a structured absence support programme developed with the HR business partner and occupational health. Begin recruitment for the permanent base manager vacancy. Target: rostering audit findings published, absence rate showing initial reduction from 14% to below 12%. Day 61 to 90 - Act and measure: implement the top three changes identified in the listening sessions. Confirm the permanent base manager appointment. Present a 12-month people strategy to the CEO and executive committee. Run a three-question pulse survey across all crew to measure movement in key engagement indicators. Target: pulse survey showing engagement improvement of at least 5 percentage points, absence below 11%, no further base manager resignations.",
        strongIndicators:["Clear and specific milestones at Day 30, 60, and 90 with measurable targets","Addresses all three core issues: engagement, absence, and retention","Listens before acting - the first 30 days prioritise diagnosis over solutions","Publishes findings transparently to the team, closing the feedback loop","Addresses the base manager vacancy immediately with an interim appointment","Involves the union in the rostering audit, building trust ahead of the formal negotiation"],
        weakIndicators:["Milestones are vague - 'improve communication' rather than specific actions and targets","Jumps to solutions in the first 30 days without a structured listening phase","Does not address the base manager vacancy as an immediate priority","No measurable targets are attached to any milestone","The union and the formal negotiation are not connected to the 90-day plan","No mechanism for closing the feedback loop with crew after the listening sessions"],
        bestAnswer:"A score of 5 response presents a 90-day plan that is specific, sequenced, measurable, and realistic. The candidate demonstrates that listening must precede action, that transparency with the team is essential to rebuilding trust, and that the three issues of engagement, absence, and retention are interconnected and must be addressed in a coordinated way. The plan acknowledges the constraint of the missing base manager and addresses it.",
        rolePlayGuide:"The resistant crew member role play involves a crew member who has 15 years of service, was informally promised a base manager role that went to an external hire, and has not had a meaningful development conversation in three years. A strong candidate will acknowledge all three grievances specifically, not generically. They will make at least one concrete commitment about the crew member's development and will not attempt to justify the external hire decision."
      },
    ],
    rolePlay:{
      title:"Role Play: Resistant Long-Serving Crew Member",
      setup:`You are meeting one-to-one with a long-serving cabin crew member who has 15 years of service with SkyServe, holds a senior crew designation, and has been visibly disengaged for the past six months. Their absence record has deteriorated, their performance ratings have dropped, and two colleagues have raised concerns about their conduct during the viral social media incident. You have been told informally that this crew member was given an informal indication by a previous base manager that they would be considered for the next base manager vacancy, which was then filled by an external hire eight months ago. They have not had a formal development conversation in over three years.`,
      setupSimple:`You are meeting one-to-one with a senior cabin crew member who has worked at SkyServe for 15 years. They have been absent more often than usual, their performance has dropped, and they were involved in the social media complaint incident. You have been told that a previous manager informally promised them the next base manager job, which was then given to someone hired from outside. They have not had any kind of career development conversation in over three years.`,
      aiRole:`You are a long-serving, experienced cabin crew member with 15 years at SkyServe. You are defensive, guarded, and deeply sceptical of new leadership. You were informally promised a base manager role and it went to an external hire without any explanation. You have not had a development conversation in three years. Your absence has increased because you feel unmotivated and undervalued. In this conversation: open with minimal engagement and one-word or brief answers. Reveal your frustrations gradually only when pressed with genuine curiosity. If the candidate listens without interrupting, acknowledges each specific grievance, and makes at least one concrete and specific commitment about your development, begin to soften. If they are dismissive, offer generic reassurance, or try to justify the external hire decision, become more resistant and closed. Stay in character throughout. Keep responses to two to four sentences.`,
      competencies:["People Leadership","Communication"],
    },
    simPrompt:`You are a senior people and leadership assessor conducting a structured competency interview on behalf of CCM Consultancy. The candidate has completed a written assessment on leading a large cabin crew workforce through a significant people crisis. Probe their leadership philosophy, their specific planned interventions, and their understanding of what drives engagement and disengagement. Never repeat a question. Rotate across: how they build trust quickly, how they handle resistance, their approach to the union relationship, how they would prioritise competing demands, and what their personal leadership style is. Keep each response to two to three sentences. Do not give feedback. Ask only questions.`,
  },
];
...
const DEVELOPMENT_ACTIVITIES = {
  Communication: {
    onJob:["Volunteer to lead the next team briefing or operational update meeting and ask a colleague to give you feedback on clarity and audience awareness afterwards.","Take on responsibility for drafting one stakeholder communication per week - whether a formal update, a passenger statement, or an internal briefing - and review it with your line manager before sending.","During your next crisis or high-pressure situation, keep a real-time log of every communication decision you make, including who you contacted, in what order, and why. Review this log in your next one-to-one."],
    social:["Ask your line manager to observe one of your team briefings and provide structured feedback on your communication style, use of language, and audience engagement.","Request to be mentored by a senior communications or operations leader who manages regular high-stakes stakeholder communications. Ask to shadow them in at least two live situations."],
    formal:["Complete the course 'Communication Foundations' on LinkedIn Learning (approximately 1.5 hours) focusing on the modules on adapting style for different audiences.","Complete 'Crisis Communication' on Coursera offered by the University of Washington (approximately 8 hours) to build a structured framework for communicating under pressure."],
  },
  Accountability: {
    onJob:["In your next team meeting, introduce a brief 'lessons learned' segment where the team reviews one recent issue and identifies what systemic change would prevent recurrence - lead this discussion and document the outcomes.","When something goes wrong in your area of responsibility, practice writing a one-page accountability memo to yourself that distinguishes between what you personally owned, what was a systemic failure, and what you would do differently.","Set up a simple accountability tracker for your team that logs commitments made, deadlines, and outcomes. Review it weekly and share the summary with your line manager monthly."],
    social:["Ask your line manager to coach you on how to conduct a post-incident debrief that balances accountability with psychological safety. Ask them to share an example of how they have done this well.","Request a mentoring conversation with a senior leader who has navigated a significant accountability challenge and ask them to walk you through their decision-making process."],
    formal:["Complete 'Developing a Culture of Accountability' on LinkedIn Learning (approximately 1 hour) to build frameworks for team-level accountability.","Complete 'Organizational Leadership' on Coursera offered by Northwestern University (approximately 4 hours) with a focus on the accountability and governance modules."],
  },
  "Strategic Thinking": {
    onJob:["Over the next 30 days, write a one-page strategic analysis of a challenge your team or department is facing. Include a SWOT analysis, at least three strategic options, and a recommended course of action with rationale.","In your next planning cycle, deliberately take a three-year view before a three-month view. Write down what success looks like in three years and work backwards to identify what must happen in the next 90 days to stay on track.","Identify one decision you are involved in over the next month and map out the second and third-order consequences of each option before making a recommendation."],
    social:["Ask your line manager to include you in one strategic planning or business review meeting above your current level as a learning opportunity. Prepare a one-page briefing in advance and share your perspective after.","Request a mentoring relationship with a senior leader who has experience in strategic planning. Ask them to review your strategic analysis documents and provide structured feedback on your thinking."],
    formal:["Complete 'Strategic Planning and Execution' on Coursera offered by the University of Virginia Darden School (approximately 10 hours) to build a rigorous strategic planning framework.","Complete 'Business Strategy' on LinkedIn Learning (approximately 2 hours) for a practical introduction to strategic frameworks used in commercial environments."],
  },
  "Decision Making": {
    onJob:["For the next four weeks, document every significant decision you make using a simple framework: what was the question, what options did you consider, what information did you have and what were you missing, and what was your rationale for the choice you made.","In your next team challenge, deliberately pause before deciding and ask two colleagues for their perspective before forming your recommendation. Note how their input changed your thinking.","Identify a recent decision that did not go as planned. Write a one-page retrospective that honestly examines what you would do differently, what information you wish you had sought, and what the systemic learning is."],
    social:["Ask your line manager to coach you on how they approach high-stakes decisions under time pressure. Ask them to walk you through a specific example from their own experience.","Request to be included in a decision-making process above your current level as an observer. Prepare your own recommendation in advance and compare it with the outcome, then debrief with your manager."],
    formal:["Complete 'Decision Making and Scenarios' on Coursera offered by the University of Cape Town (approximately 6 hours) to build structured decision frameworks.","Complete 'Making Evidence-Based Management Decisions' on LinkedIn Learning (approximately 1 hour) for practical tools applicable to operational environments."],
  },
  "People Leadership": {
    onJob:["In your next one-to-one with each team member, ask three questions you have never asked before: what is one thing about your role that you find most meaningful, what is one thing that gets in the way of your best work, and what would help you grow in the next six months. Document the answers and follow up on at least one action per person.","Over the next 30 days, make a deliberate effort to recognise one team member per day for a specific contribution. Note their reaction and reflect on what type of recognition lands best with different people.","Identify one team member who is underperforming and schedule a structured conversation using the SBI feedback model (Situation, Behaviour, Impact). Follow up with a written summary and agreed actions."],
    social:["Ask your line manager to coach you on how they have managed a resistant or disengaged team member. Ask them to role-play a difficult conversation with you and provide feedback on your approach.","Request a mentoring relationship with an experienced people leader - ideally someone who has led through a significant team challenge such as a restructure or culture change. Meet monthly and bring a real leadership challenge to each session."],
    formal:["Complete 'Leading with Emotional Intelligence' on LinkedIn Learning (approximately 2.5 hours) to build self-awareness and empathy as a foundation for people leadership.","Complete 'Inspiring and Motivating Individuals' on Coursera offered by the University of Michigan as part of the Everyday Leadership Specialisation (approximately 6 hours)."],
  },
};
...
export default function App() {
  ...
  async function handleLogin() {
    ...
    try {
      if (loginForm.username==="admin"&&loginForm.password==="ccm2024") {
        ...
        if (data&&data.length>0) { const p=data[0];setRole("participant");setUser(p);await loadUserData(p.id);setScreen("participant"); }
  ...
  function speak(text) {
    ...
    const u=new SpeechSynthesisUtterance(text);u.rate=0.92;u.pitch=1;window.speechSynthesis.speak(u);
  }
  ...
  async function callSimAI(userMsg,phase) {
    ...
    const currentCount = exchangeCount + 1;
    setExchangeCount(currentCount);
    try {
      const assessorN = settings.assessor_name || "the CCM Consultancy Assessor";
      const systemPrompt = phase==="roleplay"
        ? activeModule.rolePlay.aiRole
        : `${activeModule.simPrompt} Your name is ${assessorN}. Never repeat a question. Vary across: specific examples, challenging assumptions, lessons learned, stakeholder impact, and what they would do differently. You have had ${currentCount} exchanges. After 8 exchanges begin to wrap up naturally.`;
  ...
  async function sendAssessorQ(text) {
    ...
    try {
      const res=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:"claude-sonnet-4-20250514",max_tokens:400,system:"You are an expert assessment centre analyst for CCM Consultancy. Provide concise assessor guidance. Do not use em dashes. Use hyphens or commas instead.",messages:[{role:"user",content:`Question: "${text}"\nModule: ${mod?.title}\nCompetencies: ${mod?.competencies?.join(", ")}\n\nProvide:\n1. Competency being probed\n2. Strong answer indicators (3 bullets)\n3. Red flags (2 bullets)\n\nBe concise and practical.`}]})});
      const data=await res.json();
  ...
  async function generateAIRatings(pid,mid) {
    ...
    try {
      ...
      const prompt = `You are an expert assessment centre analyst for CCM Consultancy. Do not use em dashes in any response. Use hyphens or commas instead.

Participant: ${p.name}
Role: ${p.role||"Not specified"}
Level: ${LEVEL_LABELS[p.level]||p.level}
Module: ${mod.title}
Competencies assessed: ${mod.competencies.join(", ")}
...
Rate each competency on a 1-5 scale where: 1=Well below expectation, 2=Below expectation, 3=Meeting expectation, 4=Above expectation, 5=Exceptional.

Return a valid JSON object with exactly this structure and no markdown formatting:
{
  "ratings": {"${mod.competencies[0]}": 3${mod.competencies[1]?`, "${mod.competencies[1]}": 3`:""}},
  "interpretations": {"${mod.competencies[0]}": "2-3 sentence evidence-based interpretation in third person"${mod.competencies[1]?`, "${mod.competencies[1]}": "2-3 sentence interpretation"`:""}},
  "strengths": {"${mod.competencies[0]}": "2-3 specific strengths demonstrated"${mod.competencies[1]?`, "${mod.competencies[1]}": "2-3 specific strengths"`:""}},
  "improvements": {"${mod.competencies[0]}": "2-3 specific areas for improvement"${mod.competencies[1]?`, "${mod.competencies[1]}": "2-3 areas for improvement"`:""}},
  "overallNarrative": "3-4 sentence overall performance summary in third person",
  "developmentPlan": ["specific development action 1", "specific development action 2", "specific development action 3"]
}

Be fair, specific, and evidence-based. If answers are brief or absent, rate conservatively at 2 and note the lack of evidence.`;

      const res=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:"claude-sonnet-4-20250514",max_tokens:1500,system:"You are an expert assessment centre analyst. Return only valid JSON with no markdown, no backticks, no explanation. Never use em dashes.",messages:[{role:"user",content:prompt}]})});
      const data=await res.json();
      ...
      if (!parsed.ratings) throw new Error("Invalid response structure");
      const key=`${pid}-${mid}`;
      setAiRatings(prev=>({...prev,[key]:parsed}));
      setRatings(prev=>({...prev,[key]:parsed.ratings||{}}));
      setReportData(prev=>({...prev,[key]:parsed}));
      await saveRatings(pid,mid,parsed.ratings||{},parsed,parsed);
    } catch(e) {
      console.error("AI ratings error:",e);
      const mod2=MODULES.find(m=>m.id===mid);
      const fallbackRatings={};
      mod2?.competencies.forEach(c=>{fallbackRatings[c]=3;});
      const fallback={ratings:fallbackRatings,interpretations:{},strengths:{},improvements:{},overallNarrative:"The assessor should review the written responses and interview transcript to complete the ratings manually.",developmentPlan:["Review written responses in the dashboard.","Use the manual rating buttons to assign scores 1-5 per competency.","Add assessor notes in the text fields provided."]};
      const key=`${pid}-${mid}`;
      setAiRatings(prev=>({...prev,[key]:fallback}));
      setRatings(prev=>({...prev,[key]:fallbackRatings}));
      setReportData(prev=>({...prev,[key]:fallback}));
      await saveRatings(pid,mid,fallbackRatings,fallback,fallback);
      alert("AI could not generate automatic ratings - default scores of 3 have been applied. Please review and adjust the ratings manually using the 1-5 buttons below.");
    }
  ...
  function buildDevPlanHTML(comps, participantName) {
    const sections = comps.map(comp => {
      const acts = DEVELOPMENT_ACTIVITIES[comp];
      if (!acts) return "";
      return `
        <div style="margin-bottom:2rem;padding:1.25rem;border:1px solid #e5e5e5;border-radius:10px">
          <h3 style="color:#E8251A;margin:0 0 1rem;font-size:16px">${comp}</h3>
          <div style="margin-bottom:1rem">
            <p style="font-weight:700;font-size:13px;color:#555;text-transform:uppercase;letter-spacing:0.05em;margin:0 0 0.5rem">70% - On the job (learning by doing)</p>
            <ol style="padding-left:1.25rem;margin:0">${acts.onJob.map(a=>`<li style="margin-bottom:8px;font-size:13px;line-height:1.7;color:#333">${a}</li>`).join("")}</ol>
          </div>
          <div style="margin-bottom:1rem">
            <p style="font-weight:700;font-size:13px;color:#555;text-transform:uppercase;letter-spacing:0.05em;margin:0 0 0.5rem">20% - Learning from others (mentoring and coaching)</p>
            <ol style="padding-left:1.25rem;margin:0">${acts.social.map(a=>`<li style="margin-bottom:8px;font-size:13px;line-height:1.7;color:#333">${a}</li>`).join("")}</ol>
          </div>
          <div>
            <p style="font-weight:700;font-size:13px;color:#555;text-transform:uppercase;letter-spacing:0.05em;margin:0 0 0.5rem">10% - Formal learning (courses and programmes)</p>
            <ol style="padding-left:1.25rem;margin:0">${acts.formal.map(a=>`<li style="margin-bottom:8px;font-size:13px;line-height:1.7;color:#333">${a}</li>`).join("")}</ol>
          </div>
        </div>`;
    }).join("");
    return sections;
  ...
  function exportAssessorPDF(pid,mid) {
    const p=participants.find(x=>x.id===pid);
    const mod=MODULES.find(m=>m.id===mid);
    const r=results[pid]?.[mid];
    const rd=reportData[`${pid}-${mid}`];
    const rts=ratings[`${pid}-${mid}`]||{};
    const notes=ratingNotes;
    const promRec=promotionRecs[`${pid}-${mid}`]||"";
    const promLabel=PROMOTION_OPTIONS.find(o=>o.value===promRec)?.label||"Not yet selected";
    if (!p||!mod||!r){alert("No completed assessment data available yet for this participant.");return;}
    const rubricHtml=RUBRIC.map(rb=>`<tr><td style="padding:6px 10px;font-weight:700;color:${rb.color}">${rb.score}</td><td style="padding:6px 10px;font-weight:600">${rb.label}</td><td style="padding:6px 10px;color:#555;font-size:12px">${rb.desc}</td></tr>`).join("");
    const ratingsHtml=Object.entries(rts).map(([comp,score])=>{
      const rb=RUBRIC.find(rb=>rb.score===score)||RUBRIC[2];
      const noteKey=`${pid}-${mid}-${comp}`;
      return `<div style="margin-bottom:1.25rem;padding:1.25rem;background:${rb.bg};border-left:4px solid ${rb.color};border-radius:8px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          <strong style="font-size:16px">${comp}</strong>
          <strong style="font-size:18px;color:${rb.color}">${score}/5 - ${rb.label}</strong>
        </div>
        ${rd?.interpretations?.[comp]?`<p style="margin:0 0 8px;color:#444;font-size:13px;line-height:1.7"><strong>Assessment:</strong> ${rd.interpretations[comp]}</p>`:""}
        ${rd?.strengths?.[comp]?`<p style="margin:0 0 8px;color:#166534;font-size:13px;line-height:1.7"><strong>Strengths demonstrated:</strong> ${rd.strengths[comp]}</p>`:""}
        ${rd?.improvements?.[comp]?`<p style="margin:0 0 8px;color:#991b1b;font-size:13px;line-height:1.7"><strong>Areas for development:</strong> ${rd.improvements[comp]}</p>`:""}
        ${notes[noteKey]?`<p style="margin:0;color:#555;font-size:13px;line-height:1.7;background:#fff;padding:0.5rem;border-radius:4px;border:1px solid #ddd"><strong>Assessor notes:</strong> ${notes[noteKey]}</p>`:""}
      </div>`;
    }).join("");
    const answersHtml=mod.questions.map(q=>`<div style="margin-bottom:1.5rem;padding:1rem;border:1px solid #eee;border-radius:8px">
      <p style="margin:0 0 4px;font-size:11px;color:#888;text-transform:uppercase;letter-spacing:0.05em">[${q.competency}]</p>
      <p style="margin:0 0 8px;font-size:14px;font-weight:600;color:#111">${q.text}</p>
      <p style="margin:0;font-size:13px;line-height:1.7;color:#333;background:#f9f9f9;padding:0.875rem;border-radius:6px">${r.answers?.[q.id]||"No answer provided"}</p>
    </div>`).join("");
    const win=window.open("","_blank");
    win.document.write(`<!DOCTYPE html><html><head><title>Assessor Report - ${p.name}</title><style>body{font-family:Arial,sans-serif;padding:2.5rem;max-width:880px;color:#111;line-height:1.6}h1{color:#E8251A;margin-bottom:4px}h2{color:#222;margin-top:2rem;border-bottom:2px solid #f0f0f0;padding-bottom:0.5rem}h3{color:#444}table{width:100%;border-collapse:collapse}td,th{border:1px solid #eee;padding:8px 12px;text-align:left;font-size:13px}th{background:#f5f5f5;font-weight:600}.conf{background:#fff1f1;border:1px solid #fecdd3;padding:0.875rem 1rem;border-radius:8px;font-size:13px;color:#991b1b;margin-bottom:1.5rem}.promo{background:#eff6ff;border:1px solid #bfdbfe;padding:1rem;border-radius:8px;margin-bottom:1rem}</style></head><body>
    <h1>CCM Consultancy</h1>
    <p style="color:#888;font-size:13px;margin:0">Assessment Centre - Assessor Report (Confidential)</p>
    <hr style="border:none;border-top:1px solid #eee;margin:1rem 0">
    <div class="conf">CONFIDENTIAL - This report is for the assessing team and authorised client representatives only. It is not for direct distribution to the participant without assessor approval.</div>
    <table style="margin-bottom:1.5rem">
      <tr><td style="font-weight:600;width:20%">Participant</td><td>${p.name}</td><td style="font-weight:600;width:20%">Level</td><td>${LEVEL_LABELS[p.level]}</td></tr>
      <tr><td style="font-weight:600">Role assessed</td><td>${p.role||"Not specified"}</td><td style="font-weight:600">Assessor</td><td>${settings.assessor_name||"CCM Consultancy"}</td></tr>
      <tr><td style="font-weight:600">Module</td><td>${mod.title}</td><td style="font-weight:600">Date</td><td>${new Date().toLocaleDateString()}</td></tr>
      <tr><td style="font-weight:600">Time on written task</td><td>${Math.round((r.timeSpent||0)/60)} minutes</td><td style="font-weight:600">Weightings applied</td><td>Written ${weights.written}% / Interview ${weights.interview}% / Role play ${weights.roleplay}%</td></tr>
    </table>
    <h2>Assessor Recommendation</h2>
    <div class="promo"><strong style="font-size:15px">${promLabel}</strong>${promRec?"":" <span style='color:#888;font-size:13px'>(Please select a recommendation in the admin Reports panel before generating the final report.)</span>"}</div>
    <h2>Competency Ratings and Assessment</h2>
    ${ratingsHtml||"<p style='color:#888'>No ratings generated yet. Use the admin Reports panel to generate AI ratings and apply manual scores.</p>"}
    ${rd?.overallNarrative?`<h2>Overall Performance Summary</h2><p style="line-height:1.8;color:#333">${rd.overallNarrative}</p>`:""}
    <h2>Rating Rubric Reference</h2>
    <table><tr><th>Score</th><th>Label</th><th>Description</th></tr>${rubricHtml}</table>
    <h2>Written Responses</h2>
    ${answersHtml}
    <h2>Development Recommendations</h2>
    ${buildDevPlanHTML(mod.competencies,p.name)}
    </body></html>`);
    win.print();
  }

  function exportParticipantPDF(pid,mid) {
    const p=participants.find(x=>x.id===pid);
    const mod=MODULES.find(m=>m.id===mid);
    const rd=reportData[`${pid}-${mid}`];
    const rts=ratings[`${pid}-${mid}`]||{};
    ...
    const ratingsHtml=hasRatings?Object.entries(rts).map(([comp,score])=>{
      const rb=RUBRIC.find(rb=>rb.score===score)||RUBRIC[2];
      return `<div style="margin-bottom:1rem;padding:1rem;background:${rb.bg};border-left:4px solid ${rb.color};border-radius:8px">
        <div style="display:flex;justify-content:space-between;margin-bottom:6px">
          <strong>${comp}</strong><strong style="color:${rb.color}">${score}/5 - ${rb.label}</strong>
        </div>
        ${rd?.interpretations?.[comp]?`<p style="margin:0;color:#555;font-size:13px;line-height:1.7">${rd.interpretations[comp]}</p>`:""}
      </div>`;
    }).join(""):`<div style="padding:1.25rem;background:#fffbeb;border:1px solid #fde68a;border-radius:8px;color:#78350f;font-size:14px;line-height:1.7"><strong>Assessment under review.</strong> Your assessor is currently reviewing your responses. Your competency ratings and personalised development plan will be included in your final report once the review is complete. You will be notified when your report is ready to download.</div>`;
    const win=window.open("","_blank");
    win.document.write(`<!DOCTYPE html><html><head><title>Development Report - ${p.name}</title><style>body{font-family:Arial,sans-serif;padding:2.5rem;max-width:820px;color:#111;line-height:1.7}h1{color:#E8251A}h2{color:#222;margin-top:2rem;border-bottom:2px solid #f5f5f5;padding-bottom:0.5rem}h3{color:#333;font-size:16px}ol{padding-left:1.25rem}li{margin-bottom:8px;font-size:13px;line-height:1.7}</style></head><body>
    <h1>CCM Consultancy</h1>
    <h2 style="border:none;margin-top:0.5rem">Personal Development Report</h2>
    <p style="color:#888;font-size:13px">Prepared for: ${p.name} | ${p.role||""} | ${new Date().toLocaleDateString()}</p>
    <hr style="border:none;border-top:1px solid #eee;margin:1rem 0">
    <h2>Introduction</h2>
    <p>${p.name} participated in the CCM Consultancy Assessment Centre as part of a structured competency evaluation for the module <strong>${mod.title}</strong>. This report summarises ${p.name}'s performance across the assessed competencies and provides a personalised development plan structured using the 70-20-10 learning framework to support continued professional growth.</p>
    <h2>Competency Performance</h2>${ratingsHtml}
    ${rd?.overallNarrative&&hasRatings?`<h2>Overall Summary</h2><p>${rd.overallNarrative}</p>`:""}
    ${hasRatings?`<h2>Personalised Development Plan (70-20-10 Framework)</h2>
    <p>The following development activities are recommended for ${p.name} based on the competencies assessed during this programme. The 70-20-10 framework reflects the research evidence that most effective professional learning happens through on-the-job experience (70%), learning from others such as mentors and coaches (20%), and formal structured learning (10%).</p>
    ${buildDevPlanHTML(mod.competencies,p.name)}
    <h2>Next Steps</h2>
    <p>${p.name} is encouraged to share this development plan with their line manager within the next two weeks and to agree on which activities to prioritise in the first 90 days. The recommended approach is to begin with one activity from each of the three 70-20-10 categories for each assessed competency, and to review progress monthly in a structured one-to-one conversation. CCM Consultancy recommends a formal follow-up review at 90 days to assess progress and adjust the plan as needed.</p>`:`<h2>Next Steps</h2><p>Once the assessor review is complete, ${p.name} will receive the full version of this report including competency ratings, a detailed narrative, and a personalised 70-20-10 development plan. Please check back once you have been notified of approval.</p>`}
    <p style="font-size:12px;color:#aaa;margin-top:3rem">Prepared by CCM Consultancy. For queries please contact your HR representative or the CCM Consultancy team.</p>
    </body></html>`);
    win.print();
  }

  function exportCSV() {
    const rows=[["ID","Name","Level","Role","Module","Time (min)","Completed","Answered","Score","Recommendation"]];
    participants.forEach(p=>MODULES.forEach(mod=>{
      const r=results[p.id]?.[mod.id];
      if(r){const rec=PROMOTION_OPTIONS.find(o=>o.value===promotionRecs[`${p.id}-${mod.id}`])?.label||"Pending";rows.push([p.id,p.name,LEVEL_LABELS[p.level],p.role||"",mod.title,Math.round((r.timeSpent||0)/60),r.completedAt?.substring(0,10)||"",`${Object.keys(r.answers||{}).length}/${mod.questions.length}`,getWeightedScore(p.id,mod.id)||"Pending",rec]);}
    }));
    const a=document.createElement("a");a.href=URL.createObjectURL(new Blob([rows.map(r=>r.map(c=>`"${c}"`).join(",")).join("\n")],{type:"text/csv"}));a.download="ccm_assessment_results.csv";a.click();
  }
                  ...
                  {modResult&&(
                    <div style={{marginTop:"1rem",paddingTop:"1rem",borderTop:"1px solid #f0f0f0",display:"flex",gap:8,alignItems:"center",flexWrap:"wrap"}}>
                      ...
                      {reportRequests[reqKey]==="approved"
                        ?<button onClick={()=>exportParticipantPDF(user.id,mod.id)} style={S.btn("#f0fdf4","#16a34a")}>Download my report</button>
      ...
      <div style={S.page}>
        ...
        <div style={{maxWidth:720,margin:"0 auto",padding:"2rem 1.5rem"}}>
          ...
          <div style={{...S.card,background:"#f9f9f9",marginBottom:"1.5rem"}}>
            <p style={{margin:"0 0 0.5rem",fontSize:14,fontWeight:600,color:"#111"}}>What to expect in this module</p>
            <p style={{margin:"0 0 4px",fontSize:13,color:"#666"}}>Part 1 - Written questions ({activeModule.duration} minutes, timed)</p>
            <p style={{margin:"0 0 4px",fontSize:13,color:"#666"}}>Part 2 - Live interview with the CCM Consultancy Assessor (voice and text)</p>
            <p style={{margin:0,fontSize:13,color:"#666"}}>Part 3 - Role play exercise: {activeModule.rolePlay.title}</p>
            <div style={{marginTop:"0.75rem",padding:"0.75rem",background:"#fffbeb",borderRadius:8,fontSize:12,color:"#92400e"}}>Your camera will be activated during the interview for identity verification. Please ensure you are in a quiet, well-lit space before beginning.</div>
          </div>
      ...
      <div style={S.page}>
        ...
        <div style={{maxWidth:720,margin:"0 auto",padding:"2rem 1.5rem"}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"1.25rem"}}>
            <h2 style={{margin:0,fontSize:18,fontWeight:700,color:"#111"}}>{activeModule.title} - Written Assessment</h2>
    ...
    return (
      <div style={S.page}>
        ...
        <div style={{maxWidth:960,margin:"0 auto",padding:"2rem 1.5rem"}}>
          ...
          {adminTab==="guide"&&(
            <div style={{display:"flex",flexDirection:"column",gap:16}}>
              <div style={{background:"#fffbeb",border:"1px solid #fde68a",borderRadius:10,padding:"1rem",fontSize:13,color:"#78350f",lineHeight:1.7}}>
                <strong>Assessor guide - confidential.</strong> This section contains model answers, strong and weak indicators, best answer descriptions, and role play guidance for every question across all three modules.
              </div>
              {MODULES.map(mod=>(
                        ...
                        return (
                          <div key={g.qId} style={{border:"1px solid #e5e5e5",borderRadius:10,overflow:"hidden"}}>
                            <div onClick={()=>setExpandedGuideQ(isOpen?null:`${mod.id}-${g.qId}`)} style={{padding:"1rem",cursor:"pointer",background:"#fafafa",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                              <div style={{display:"flex",alignItems:"center",gap:10}}>
                                <span style={S.badge("#fff1f1",CCM_RED)}>{g.competency}</span>
                                <span style={{fontSize:14,fontWeight:600,color:"#111"}}>Question {gi+1}</span>
                              </div>
                            ...
                            {isOpen&&(
                              <div style={{padding:"1rem",display:"flex",flexDirection:"column",gap:14}}>
                                ...
                                <div style={{background:"#f0fdf4",borderRadius:8,padding:"1rem",border:"1px solid #bbf7d0"}}>
                                  <p style={{...S.label,color:"#16a34a"}}>Model answer</p>
                                  <p style={{margin:0,fontSize:13,lineHeight:1.9,color:"#166534"}}>{g.modelAnswer}</p>
                                </div>
                                <div style={{background:"#eff6ff",borderRadius:8,padding:"1rem",border:"1px solid #bfdbfe"}}>
                                  <p style={{...S.label,color:"#0369a1"}}>What a score of 5 looks like</p>
                                  <p style={{margin:0,fontSize:13,lineHeight:1.8,color:"#1e40af"}}>{g.bestAnswer}</p>
                                </div>
                                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
                                  <div style={{border:"1px solid #bbf7d0",borderRadius:8,padding:"0.875rem"}}>
                                    <p style={{...S.label,color:"#16a34a"}}>Strong indicators</p>
                                    {g.strongIndicators.map((s,i)=><p key={i} style={{margin:"0 0 6px",fontSize:13,color:"#166534",lineHeight:1.5}}>✓ {s}</p>)}
                                  </div>
                                  <div style={{border:"1px solid #fecdd3",borderRadius:8,padding:"0.875rem"}}>
                                    <p style={{...S.label,color:CCM_RED}}>Weak indicators and red flags</p>
                                    {g.weakIndicators.map((s,i)=><p key={i} style={{margin:"0 0 6px",fontSize:13,color:"#991b1b",lineHeight:1.5}}>✗ {s}</p>)}
                                  </div>
                                </div>
                                {g.rolePlayGuide&&<div style={{background:"#fffbeb",border:"1px solid #fde68a",borderRadius:8,padding:"0.875rem"}}>
                                  <p style={{...S.label,color:"#92400e"}}>Role play assessor guidance</p>
                                  <p style={{margin:0,fontSize:13,lineHeight:1.8,color:"#78350f"}}>{g.rolePlayGuide}</p>
                                </div>}
                              </div>
                            )}
                          </div>
          ...
          {adminTab==="live_assessor"&&(
            <div style={{display:"grid",gridTemplateColumns:"240px 1fr",gap:16}}>
              ...
              <div>
                ...
                ):<div style={{...S.card,display:"flex",alignItems:"center",justifyContent:"center",height:300,color:"#bbb",fontSize:14}}>Select a participant and module to begin a live session</div>}
              </div>
            </div>
          )}
          ...
          {adminTab==="reports"&&(
            <div style={{display:"flex",flexDirection:"column",gap:16}}>
              ...
              <div style={{background:"#fffbeb",border:"1px solid #fde68a",borderRadius:10,padding:"1rem",fontSize:13,color:"#78350f"}}>
                <strong>Weightings applied:</strong> Written {weights.written}% / Interview {weights.interview}% / Role play {weights.roleplay}% (total: {totalWeight}%) - adjust in Settings.
              </div>
                  ...
                  <div key={key} style={S.card}>
                    <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"1rem",flexWrap:"wrap",gap:8}}>
                      ...
                      <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
                        {reportRequests[key]==="pending"&&<button onClick={()=>saveReportRequest(p.id,mod.id,"approved")} style={{...S.btn("#f0fdf4","#16a34a"),border:"1px solid #86efac"}}>Approve report request</button>}
                        ...
                        <button onClick={()=>exportAssessorPDF(p.id,mod.id)} style={S.btn(CCM_RED,"#fff")}>Assessor PDF</button>
                        <button onClick={()=>exportParticipantPDF(p.id,mod.id)} style={S.btn("#f9f9f9","#555")}>Participant PDF</button>
                      </div>
                    </div>
                    <div style={{marginBottom:"1rem",padding:"0.875rem",background:"#f9f9f9",border:"1px solid #e5e5e5",borderRadius:10}}>
                      ...
                      <p style={{margin:"6px 0 0",fontSize:12,color:"#888"}}>This recommendation appears in the Assessor PDF report. It is not shared with the participant.</p>
                    </div>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:16}}>
              <div style={S.card}>
                ...
                <div style={{marginBottom:12}}>
                  ...
                  {clientLogo&&<div style={{marginTop:10,display:"inline-flex",alignItems:"center",gap:12,padding:"0.75rem",background:"#f9f9f9",borderRadius:8}}><img src={clientLogo} style={{height:36,objectFit:"contain"}} alt="Logo preview"/><button onClick={()=>setClientLogo(null)} style={{fontSize:12,color:CCM_RED,background:"none",border:"none",cursor:"pointer"}}>Remove</button></div>}
                </div>
                <div style={{marginBottom:12}}>
                ...
                <div style={{display:"flex",flexDirection:"column",gap:8}}>
                  {participants.map(p=>(
                    <div key={p.id} style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"0.875rem",background:"#f9f9f9",borderRadius:8,border:"1px solid #e5e5e5"}}>
                      <div><p style={{margin:0,fontWeight:600,fontSize:14,color:"#111"}}>{p.name}</p><p style={{margin:"2px 0 0",fontSize:12,color:"#888"}}>{p.role} - {LEVEL_LABELS[p.level]} - Username: {p.username}</p></div>
                    </div>
                  ))}
                </div>
              </div>
