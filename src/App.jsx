...
const [editCompSaving, setEditCompSaving] = useState(false);
  ...
  const emptyTimeForm = { reading_time_mins:5, break_duration_mins:10, part2_mode:"written", sup_q_mins:45, sup_task_mins:30, mgr_q_mins:60, mgr_task_mins:45, dir_q_mins:75, dir_task_mins:60 };
  ...
  function selectMbModule(moduleId) {
    ...
    setMbTimeForm({
      ...
      part2_mode:          mod?.part2_mode           ?? "written",
              ...
              {mbSelModId && (
                <div style={{ maxWidth:760 }}>
                  ...
                  <div style={{ ...S.card, marginBottom:"1.5rem" }}>
                    ...
                    <div style={{ marginBottom:16 }}>
                      <label style={S.label}>Part 2 Delivery Mode</label>
                      <select
                        style={{ ...S.input, width:220 }}
                        value={mbTimeForm.part2_mode || "written"}
                        onChange={e => setMbTimeForm(f => ({ ...f, part2_mode: e.target.value }))}
                      >
